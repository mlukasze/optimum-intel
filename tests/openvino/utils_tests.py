...
def get_supported_model_for_library(library_name):
    ...
    for model_type in supported_model_type:
        if supported_model_type[model_type].get("openvino"):
            ...
            min_transformers = str(getattr(export_config.func, "MIN_TRANSFORMERS_VERSION", "0") or "0")
            max_transformers = str(getattr(export_config.func, "MAX_TRANSFORMERS_VERSION", "999") or "999")
